...
const QUESTION_BANK = [
  { id: 1, category: 'Kawasan Silalas', question: 'Ada berapa walking trails yang ditampilkan di kawasan Silalas?', options: ['3 rute', '4 rute', '5 rute', '6 rute'], correct: '5 rute', explanation: 'Halaman Silalas menampilkan lima rute jalan kaki.', image: 'assets/kampung-silalas.webp', alt: 'Suasana kawasan Silalas di Medan' },
  { id: 2, category: 'Baca Rute', question: 'Berapa estimasi waktu untuk menempuh Trails 1 Tepian Sungai Deli?', options: ['30 menit', '35 menit', '60 menit', '90 menit'], correct: '60 menit', explanation: 'Estimasi Trails 1 adalah 1,0 jam atau 60 menit.', image: 'assets/deli-riverview.webp', alt: 'Pemandangan tepian Sungai Deli' },
  { id: 3, category: 'Baca Rute', question: 'Berapa jumlah POI atau lokasi pada Trails 1?', options: ['8 POI', '12 POI', '15 POI', '20 POI'], correct: '15 POI', explanation: 'Pada informasi rute tercantum 15 POI.', image: 'assets/deli-riverview.webp', alt: 'Salah satu lokasi di Trails 1 Tepian Sungai Deli' },
  { id: 4, category: 'Baca Rute', question: 'Berapa jarak Trails 1 Tepian Sungai Deli?', options: ['0,7 km', '1,2 km', '1,6 km', '2,3 km'], correct: '1,6 km', explanation: 'Jarak Trails 1 yang tercantum adalah 1,6 kilometer.', image: 'assets/deli-riverview.webp', alt: 'Jalur tepian Sungai Deli' },
  { id: 5, category: 'Baca Rute', question: 'Berapa perkiraan jumlah langkah pada Trails 1?', options: ['1.100 langkah', '1.400 langkah', '2.000 langkah', '2.300 langkah'], correct: '2.300 langkah', explanation: 'Perkiraan perjalanan Trails 1 adalah 2.300 langkah.', image: 'assets/kampung-silalas.webp', alt: 'Gang yang menjadi bagian dari rute jalan kaki Silalas' },
  { id: 6, category: 'Kategori Lokasi', question: 'Jembatan Kereta Api pada Trails 1 termasuk kategori apa?', options: ['iSee', 'iEat', 'iDrink', 'iSurprise'], correct: 'iSurprise', explanation: 'Jembatan Kereta Api termasuk iSurprise, yaitu kejutan menarik yang sering terlewat.', image: 'assets/jembatan-rel.webp', alt: 'Jembatan rel kereta api tua di atas Sungai Deli' },
  { id: 7, category: 'Kategori Lokasi', question: 'Manakah tempat kategori iEat pada Trails 1?', options: ['Masjid Al Muflihin', 'Dapur Sedap Wangi', 'Rumah Qohwah', 'Florist'], correct: 'Dapur Sedap Wangi', explanation: 'Dapur Sedap Wangi tercantum sebagai lokasi kategori iEat.', image: 'assets/jajanan-lokal.webp', alt: 'Makanan lokal yang dapat ditemukan saat menjelajah Silalas' },
  { id: 8, category: 'Kategori Lokasi', question: 'Manakah tempat kategori iDrink pada Trails 1?', options: ['Rumah Qohwah', 'Jl. Kemiri', 'Jembatan Kereta Api', 'Masjid Haji Maraset'], correct: 'Rumah Qohwah', explanation: 'Rumah Qohwah tercantum sebagai lokasi kategori iDrink.', image: 'assets/rumah-qohwah.webp', alt: 'Rumah Qohwah di kawasan Silalas' },
  { id: 9, category: 'Bandingkan Rute', question: 'Rute mana yang memiliki jarak paling panjang di Silalas?', options: ['Trails 1 Tepian Sungai Deli', 'Trails 2 Lanskap Kampung Melayu', 'Trails 4 Masjid Tua Silalas', 'Trails 5 Kampung & Pemakaman Hijau'], correct: 'Trails 1 Tepian Sungai Deli', explanation: 'Dengan jarak 1,6 km, Trails 1 adalah yang paling panjang.', image: 'assets/deli-riverview.webp', alt: 'Kawasan tepian sungai pada Trails 1' },
  { id: 10, category: 'Bandingkan Rute', question: 'Rute mana yang memiliki jarak paling pendek di Silalas?', options: ['Trails 1 Tepian Sungai Deli', 'Trails 3 Rumah Tradisional Melayu', 'Trails 4 Masjid Tua Silalas', 'Trails 5 Kampung & Pemakaman Hijau'], correct: 'Trails 4 Masjid Tua Silalas', explanation: 'Trails 4 memiliki jarak 0,702 km, paling pendek dari lima rute.', image: 'assets/masjid-silalas.webp', alt: 'Masjid bersejarah di kawasan Silalas' },
  { id: 11, category: 'Kenali Rute', question: 'Rute mana yang mengajak peserta menyusuri lanskap Kampung Melayu?', options: ['Trails 1', 'Trails 2', 'Trails 3', 'Trails 5'], correct: 'Trails 2', explanation: 'Trails 2 bertema Lanskap Kampung Melayu.', image: 'assets/kampung-silalas.webp', alt: 'Lanskap permukiman Kampung Melayu di kawasan Silalas' },
  { id: 12, category: 'Kenali Rute', question: 'Rute mana yang berfokus pada rumah tradisional Melayu?', options: ['Trails 1', 'Trails 2', 'Trails 3', 'Trails 4'], correct: 'Trails 3', explanation: 'Trails 3 bertema Rumah Tradisional Melayu.', image: 'assets/kampung-silalas.webp', alt: 'Lingkungan rumah tradisional Melayu di kawasan Silalas' },
  { id: 13, category: 'Kenali Rute', question: 'Rute mana yang bertema Masjid Tua Silalas?', options: ['Trails 2', 'Trails 3', 'Trails 4', 'Trails 5'], correct: 'Trails 4', explanation: 'Trails 4 mengajak peserta mengenal Masjid Tua Silalas.', image: 'assets/masjid-silalas.webp', alt: 'Masjid tua di kawasan Silalas' },
  { id: 14, category: 'Kenali Rute', question: 'Rute mana yang memadukan suasana kampung dan pemakaman hijau?', options: ['Trails 1', 'Trails 3', 'Trails 4', 'Trails 5'], correct: 'Trails 5', explanation: 'Trails 5 bertema Kampung dan Pemakaman Hijau.', image: 'assets/kampung-silalas.webp', alt: 'Lingkungan hijau di kawasan Kampung Silalas' },
  { id: 15, category: 'Kategori Lokasi', question: 'Apa arti kategori iSurprise dalam perjalanan?', options: ['Tempat makan utama', 'Tempat minum', 'Kejutan menarik yang sering terlewat', 'Tempat berbelanja'], correct: 'Kejutan menarik yang sering terlewat', explanation: 'iSurprise menandai temuan menarik yang mudah terlewat saat menjelajah.', image: 'assets/jembatan-rel.webp', alt: 'Jembatan kereta api sebagai salah satu kejutan perjalanan' }
];
